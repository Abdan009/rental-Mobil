...
class EditProfilPemilik extends StatefulWidget {
  final Users user;
  final format = DateFormat("dd-MM-yyyy");
  EditProfilPemilik(this.user);
  @override
  _EditProfilPemilikState createState() => _EditProfilPemilikState();
}

class _EditProfilPemilikState extends State<EditProfilPemilik> {
