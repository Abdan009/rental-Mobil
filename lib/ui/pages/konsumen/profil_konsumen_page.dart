...
class ProfilKonsumenPage extends StatefulWidget {
  @override
  _ProfilKonsumenPageState createState() => _ProfilKonsumenPageState();
}

class _ProfilKonsumenPageState extends State<ProfilKonsumenPage> {
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: RaisedButton(
                      color: mainColor,
                      onPressed: (){
                        Get.to(EditProfilKonsumen(user));
                    },
